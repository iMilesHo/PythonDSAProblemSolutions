...
if __name__ == "__main__":
    ...
    # Example 1
    assert s.canCompleteCircuit([1,2,3,4,5], [3,4,5,1,2]) == 3, "Example 1 failed"

    # Example 2
    assert s.canCompleteCircuit([2,3,4], [3,4,3]) == -1, "Example 2 failed"

    assert s.canCompleteCircuit([5], [3]) == 0
    assert s.canCompleteCircuit([1], [2]) == -1
    assert s.canCompleteCircuit([0,0,0,4], [1,1,1,1]) == 3
